...
- Not yet verified: auto-update end to end (needs the next release), live Google sign-in on web, live email-code delivery via Resend, the Magic Link template edit, custom-domain deploy.
